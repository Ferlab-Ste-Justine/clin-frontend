...
const fr = {
  ...
  'screen.patient.creation.ok': 'Créer le patient',
  'screen.patient.creation.type': 'Prescription pour un',
  ...
  'screen.patient.creation.success.description': 'Le patient a été créé avec succès.',
  'screen.patient.creation.success.patientCard': 'Voir la fiche du patient.',
  'screen.patient.creation.success.newPatient': 'Créer un nouveau patient',
  'screen.patient.creation.success.newPrescription': 'Créer une prescription pour ce patient',
  'screen.patient.creation.existing.description': 'Nous avons trouvé un patient avec les mêmes identifiants.',
  'screen.patient.creation.existing.patientCard': 'Voir la fiche du patient',
