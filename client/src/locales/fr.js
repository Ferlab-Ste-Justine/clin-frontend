...
const fr = {
  ...
  'screen.patient.details.status.on-hold': 'En attente',
  'screen.patient.details.status.active': 'Actif',
  'screen.patient.details.status.revoked': 'Révoqué',
  'screen.patient.details.status.completed': 'Compléter',
