...
const fr = {
  ...
  'screen.patient.details.status.active.description': 'Cette requête est valide, complète, conforme et elle peut être envoyée au laboratoire génomique. Les données cliniques de cette requête ne pourront plus être modifiées.',
  'screen.patient.details.status.revoked': 'Refusée',
  'screen.patient.details.status.revoked.description': 'La demande de séquençage génomique pour ce patient est refusée. Veuillez préciser la raison du refus ici.',
  'screen.patient.details.status.completed': 'Complétée',
  'screen.patient.details.status.completed.description': 'Cette requête a été complété par le généticien et les données ainsi que les rapports sont disponibles dans la plateforme. Les données cliniques de cette requête ne pourront plus être modifiées',
  'screen.patient.details.status.incomplete': 'Incomplète',
  'screen.patient.details.status.incomplete.description': "Cette requête n'est pas conforme ou qu'il manque de l'information. Veuillez préciser les changements à apporter pour des fins d'approbation.",
