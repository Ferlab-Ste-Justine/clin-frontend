...
const fr = {
  ...
  'screen.patientvariant.statementConfirmDraft.modal.content': 'Vous êtes sur le point de créer un nouveau filtre; toutes modifications sera perdues',
  ...
  'screen.patientvariant.statementConfirmDuplicate.modal.content': 'Vous êtes sur le point de dupliquer le filtre en cours; toutes modifications sera transférées dans le nouveau filtre dupliqué',
  ...
  'screen.patientvariant.statementConfirmSelect.modal.content': 'Vous êtes sur le point de changer de filtre; toutes modifications sera perdues',
  ...
  'screen.patientvariant.statementConfirmLoss.modal.title': 'Opération destructive',
  'screen.patientvariant.statementConfirmLoss.modal.content': 'Vous êtes sur le point de perdre toutes vos modifications',
  'screen.patientvariant.statementConfirmLoss.modal.ok': 'PROCÉDER',
  'screen.patientvariant.statementConfirmLoss.modal.cancel': 'CANCEL',
  //
