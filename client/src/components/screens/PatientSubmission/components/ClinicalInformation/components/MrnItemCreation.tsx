...
import { Identifier } from 'helpers/fhir/types';
          ...
          rules={[
            {
              message: (
                <ErrorText
                  text={intl.get('form.patientSubmission.clinicalInformation.validation.mrn')}
                />
              ),
              required: true,
            },
          ...
          rules={[
            {
              message: (
                <ErrorText
                  text={intl.get(
                    'form.patientSubmission.clinicalInformation.validation.requiredField',
                  )}
                />
              ),
              required: true,
